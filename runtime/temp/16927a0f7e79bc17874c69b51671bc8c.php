<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./application/admin/view/goods\categoryList.html";i:1569377698;s:43:"./application/admin/view/public\layout.html";i:1586428862;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <form method="post">
    ...
    <div class="flexigrid">
          ...
          <table cellspacing="0" cellpadding="0">
            <thead>
              <tr>
                ...
                <th align="center" axis="col8"><div style="text-align: center; width: 60px;">跳转</div></th>
      ...
      <div class="tDiv">
        <div class="tDiv2">
         <a href="<?php echo Url('Goods/addEditCategory'); ?>">
          <div class="fbutton">
          ...
          <tr data-level="<?php echo $vo[level]; ?>" parent_id_path ="<?php echo $vo['parent_id_path']; ?>" class="parent_id_<?php echo $vo['parent_id']; ?>" nctype="0" <?php if($vo[level] > 1): ?> style="display:none;"<?php endif; ?>>
              ...
              <td class="handle">
                <div style="text-align:center;   min-width:150px !important; max-width:inherit !important;">
                  ...
                  <ul>
                    <li><a href="<?php echo Url('Goods/addEditCategory',array('id'=>$vo['id'])); ?>">编辑分类信息</a></li>
                    <!--<li><a href="<?php echo Url('Goods/addEditCategory',array('parent_id'=>$vo['id'])); ?>">新增下级分类</a></li>-->
                    <li><a href="javascript:del_fun('<?php echo Url('Goods/delGoodsCategory',array('id'=>$vo['id'])); ?>');">删除当前分类</a></li>
                  </ul>
                  </span>
                </div>
              </td>
              ...
              <td class="sort">
                <div style="text-align: center; width: 60px;">
                  <input type="text" onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onChange="changeTableVal('goods_category','id','<?php echo $vo['id']; ?>','cat_jump',this)" size="4" value="<?php echo $vo['cat_jump']; ?>" />
                </div>
              </td>     
              <td class="sort">
                <div style="text-align: center; width: 60px;">
