<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/admin\index.html";i:1586425063;s:43:"./application/admin/view/public\layout.html";i:1586428862;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<th align="center" abbr="article_show" axis="col5" class="">
							<div style="text-align: left; width: 100px;" class="">所属板块</div>
						</th>
						<th align="center" abbr="article_show" axis="col5" class="">
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo $vo['plate']; ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="">
								<div style="text-align: left; width: 200px;"><?php echo $vo['mobile']; ?></div>
							</td>
							<td align="left" class="">
