<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./application/admin/view/public\dispatch_jump.html";i:1555047574;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
    <title>一礼通 | 后台登陆</title>
...
<?php if($code == 1) {?>    
      ...
      <div class="login-box-body">
        <h4 class="login-box-msg ver_cm"><span class="glyphicon glyphicon-ok ver_cm"></span> <?php echo(strip_tags($msg)); ?></h4>
          ...
          <a href="login" target="_parent">管理员后台</a>
