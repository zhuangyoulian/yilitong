...
class captcha
{
    ...
    var $themes_jpg = array(
        ...
        5 => array('captcha_bg5.jpg', 255, 255, 255), */
    		...
    		1 => array('captcha_bg2.jpg', 0, 0, 0),
    		2 => array('captcha_bg4.jpg', 255, 255, 255),
    ...
    var $themes_gif = array(
        ...
        5 => array('captcha_bg5.gif', 255, 255, 255), */
    		1 => array('captcha_bg2.gif', 0, 0, 0),
    		2 => array('captcha_bg4.gif', 255, 255, 255),
    );
...
//        $_SESSION[$this->session_word] = "";
     ...
     * @return  mix
     */
    function api_generate_image($word = false)
    {
...
//             imagedestroy($img_org);
    ...
    function generate_sms($mobile,$word = false)
    {
    	if (!$word)
    	{
    		//$word = $this->generate_word();
     ...
     * 注册成功，发送短信消息
     */
    function send_zhuce_success($mobile){
    		include_once('includes/cls_sms1.php');
    		$sms = new sms1();
    		$content = "终于等到你，→128元红包已到账←首单省18元，全球好货任性购 http://t.cn/R5WV4ll 退订回复T";
    		$sms->send($mobile, $content);
    		return true;
    }
}
