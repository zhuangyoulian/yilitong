...
/*退货/退款状态*/
$_LANG['back_status'][1] = '等待受理';
$_LANG['back_status'][2] = '受理通过';
$_LANG['back_status'][3] = '受理未通过';
$_LANG['back_status'][4] = '退款通过';
$_LANG['back_status'][5] = '退款不通过';
...
/*2.0*/
$_LANG['label_username'] = '购买会员：';
$_LANG['label_tariff'] = '关税：';
$_LANG['label_order_privilege'] = '订单优惠：';
$_LANG['label_order_commission'] = '佣金：';
$_LANG['label_take_good'] = '收货方式：';
$_LANG['label_good_weight'] = '商品重量：';
$_LANG['label_get_ykbean'] = '获得小洋豆：';
$_LANG['label_get_expressage'] = '快递跟踪：';
$_LANG['label_fx_member'] = '上级会员：';
$_LANG['label_order_mom'] = '主单号：';
$_LANG['label_order_seenow'] = '正在查看的订单：';

$_LANG['label_common_info'] = '通用信息';
$_LANG['label_receive_a_refund'] = '收退款操作';
$_LANG['label_consignee_or_consignor'] = '收退货操作';
$_LANG['label_preferential_plan'] = '优惠方案';
$_LANG['label_order_log'] = '订单日志';
$_LANG['label_expressage'] = '物流跟踪';
$_LANG['label_order_remark'] = '订单备注';
$_LANG['label_user_message'] = '用户留言';

$_LANG['confirm_remark'] = '确认提交？';
$_LANG['confirm_remark_error'] = '内容不能为空！！';
$_LANG['logistics_null'] = '对不起，暂无物流流转信息';
$_LANG['click_info'] = '点击查询';
$_LANG['data_null'] = '无';
$_LANG['subremark'] = '提交';
?>