...
class qq extends Model{
	...
	public function __construct($config){
      	...
      	if ($_SERVER["REQUEST_URI"]=="/home/LoginApi/login/oauth/qq.html" or $_SERVER["REQUEST_URI"]=="/index.php/home/LoginApi/login/oauth/qq.html") {
	...
	public function respon(){
        //dump($_REQUEST['state']);dump($_SESSION['state']);die;
