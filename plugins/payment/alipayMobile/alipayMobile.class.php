...
{    
    ...
    public function  __construct() {   
        ...
        $paymentPlugin = Db::name('Plugin')->where("code='alipayMobile' and  type = 'payment' ")->find(); // 找到支付插件的配置
    ...
    {         
            ...
            $parameter = array(
                        ...
                        "notify_url"	=> SITE_URL.Url::build('Payment/notifyUrl',array('pay_code'=>'alipayMobile')) , //服务器异步通知页面路径 //必填，不能修改
                        "return_url"	=> SITE_URL.Url::build('Payment/returnUrl',array('pay_code'=>'alipayMobile')),  //页面跳转同步通知页面路径
                        ...
                        "subject"       =>"一礼通商城订单", //订单名称，必填
                        "total_fee"	=> $order['order_amount'], //付款金额
                        "show_url"	=> "http://yilitong.com", //收银台页面上，商品展示的超链接，必填
    ...
    {                
        ...
        $verify_result = $alipayNotify->verifyNotify();
            ...
            if($verify_result) //验证成功
            {
                    ...
                    $_POST['transaction_id']=  $_POST['trade_no']; //支付宝交易号                   
