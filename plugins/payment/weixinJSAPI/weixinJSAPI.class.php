...
class weixinJSAPI extends Model
{    
    ...
    public function  __construct() {   
		...
		$paymentPlugin = Db::name('Plugin')->where("code='weixinJSAPI' and type = 'payment'")->find();  //微信JSAPI支付
    ...
    {    
            ...
            $notify_url = SITE_URL.'/index.php/Home/Payment/notifyUrl/pay_code/weixinJSAPI'; // 接收微信支付异步通知回调地址，通知url必须为直接可访问的url，不能携带参数。
    ...
    function getJSAPI($order){
        ...
        // $input->SetNotify_url('http://www.yilitong.com/index.php/Home/Payment/notify');
        $input->SetNotify_url('http://www.yilitong.com/index.php/Home/Payment/notifyUrl/pay_code/weixinJSAPI');
