...
class Ueditor extends Base
{
    ...
    public function getContent()
    {
        echo '<meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
            <script src="/public/Ueditor/ueditor.parse.js" type="text/javascript"></script>
    ...
    public function imageManager()
    {
        ...
        if ($action == "get") {
            if (!defined('SAE_TMP_PATH')) {
                ...
                */
                $num = 0;
                while ($ret = $st->getList(config('SaeStorage'), null, 100, $num)) {
                    foreach ($ret as $file) {
    ...
    {       
        ...
        $result = $this->validate(
            ['file2' => $file], 
            ['file2'=>'image','file2'=>'fileSize:1500000'],
