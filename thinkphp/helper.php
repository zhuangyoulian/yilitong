...
if (!function_exists('D')) {
    ...
    {               
        ...
        if(file_exists(APP_PATH."/home/model/$name.php"))
            $class = '\ylt\home\model\\'.$name;
        elseif(file_exists(APP_PATH."/supplier/model/$name.php"))
            $class = '\ylt\supplier\model\\'.$name;
        elseif(file_exists(APP_PATH."/api/model/$name.php"))                 
            $class = '\ylt\api\model\\'.$name;
        elseif(file_exists(APP_PATH."/admin/model/$name.php"))
            $class = '\ylt\admin\model\\'.$name;
